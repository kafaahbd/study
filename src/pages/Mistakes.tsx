                    ...
                    {selectedSubject && !practiceMode && (
                        ...
                        >
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
                                ...
                                >
                                    <Play size={18} fill="currentColor" /> {lang === "bn" ? "শুরু করুন" : "Start Practice"}
                                </button>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                {mistakes.map((m, idx) => (
                                    <div key={idx} className="p-6 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-100 dark:border-gray-700 flex items-start gap-4">
                        ...
                        >
                            ...
                            <div className="mb-10">
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    {Object.entries(mistakes[currentIndex].question_data.options).map(([key, value]) => {
                                        ...
                                        let buttonClass = "w-full p-6 rounded-3xl border-2 text-left font-bold transition-all flex items-center justify-between group ";
                                        ...
                                        return (
                                            ...
                                            >
                                                <span className="flex items-center gap-4">
                                                    <span className={`w-8 h-8 rounded-xl flex items-center justify-center text-xs font-black ${isSelected ? 'bg-current text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500'}`}>
                                                        {key}
                                                    </span>
                                                    {value as string}
                                                </span>
                            ...
                            {isAnswered && (
                                <motion.div
                                    ...
                                    className="mb-10"
                                >
                                    <div className={`p-8 rounded-[2rem] mb-8 ${isCorrect ? 'bg-green-50 dark:bg-green-900/20 text-green-800 dark:text-green-300' : 'bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-300'} border border-current/10 shadow-inner`}>
