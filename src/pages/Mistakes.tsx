                        ...
                        >
                            ...
                            {isAnswered && (
                                <motion.div
                                    ...
                                    className="mb-10"
                                >
                                    <div className={`p-6 rounded-3xl mb-8 ${isCorrect ? 'bg-green-50 dark:bg-green-900/20 text-green-800 dark:text-green-300' : 'bg-red-50 dark:bg-red-900/20 text-red-800 dark:text-red-300'}`}>
